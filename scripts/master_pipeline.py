...
class MasterPipeline:
    ...
    def run_hyperopt(self) -> Dict[str, str]:
        ...
        for model in models:
            ...
            cmd = [
                "python", "-m", "suicide_detection.hyperopt.optuna_runner",
                "--model", model,
                "--config", "configs/hyperopt.yaml",
    ...
    def run_cross_dataset_evaluation(self) -> Dict[str, str]:
        ...
        cmd = [
            "python", "scripts/cross_dataset_evaluate.py",
    ...
    def run_transformer_variants(self) -> Dict[str, str]:
        ...
        variants = self.config.get('transformers', {}).get('variants', [
            'bert-base-uncased',
            'roberta-base',
